...
#     torch.backends.cudnn.benchmark = True
    ...
    train_set = TrainDatasetFromFolder('/home/mist/VOC2012/train', crop_size=CROP_SIZE, upscale_factor=UPSCALE_FACTOR)
    val_set = ValDatasetFromFolder('/home/mist/VOC2012/val', upscale_factor=UPSCALE_FACTOR)
    ...
    for epoch in tqdm(range(1, NUM_EPOCHS + 1), desc="Epoch"):
        ...
        for iteration, datas in tqdm(enumerate(train_loader, 1),
            ...
            gradient_penalty = compute_gradient_penalty(device, netD, real_img, fake_img)
            # Modification 3: remove log(adv) 
            d_loss = - real_out + fake_out + gradient_penalty*0.001
            ...
            writer.add_scalar("Loss/WGAN-gp", gradient_penalty.item(), step)
