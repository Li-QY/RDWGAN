...
parser.add_argument('--model_name', default='netG_epoch_4_481.pth', type=str, help='generator model epoch name')
...
# model =Generator_RDN(4,3,64,4,5)
if use_cuda:
    model = model.cuda()
model.load_state_dict(torch.load('/home/mist/SDRGAN_v1/epochs/' + exp_id + '/' + MODEL_NAME))
#,map_location='cpu'

test_set = TestDatasetFromFolder('/home/mist/test', upscale_factor=UPSCALE_FACTOR)
